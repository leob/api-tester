...
export function allTracks(state: SessionState): string[] {
...
export function allFiltered(state: SessionState): Session[] {
...
export function favoritesFiltered(state: SessionState): Session[] {
  let searchSessions = searchText(state.searchText);
  let searchTracks = filterByTrack(state.trackFilters);
